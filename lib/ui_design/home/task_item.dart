                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            margin: EdgeInsets.symmetric(vertical: 12,horizontal: 12),
                            child: Text(widget.task.description,textAlign:TextAlign.start,
                  ...
                  InkWell(
                    ...
                    Container(
                      ...
                      child: Text(settingsprovider.currentLanguage=='en'?"Done !":'تم!',style: Theme.of(context).textTheme.headline5!.copyWith(color: MyTheme.Green),),
                    )
                        :Container(
                      margin: EdgeInsets.symmetric(horizontal: 10),
                      padding: EdgeInsets.symmetric(vertical: 8,horizontal:16),
