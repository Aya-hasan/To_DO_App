                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: Text(
                            "Edit Task",
                            style: Theme.of(context).textTheme.headline5?.copyWith(color:settingsprovider.isDarkMode()?Colors.white:Colors.black),
                          )),
                      Column(
                        children: [
                          Container(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    labelStyle: TextStyle(
                                      fontSize: Theme.of(context)
                                          .textTheme
                                          .headline4!
                                          .fontSize,color:settingsprovider.isDarkMode()?Colors.white:Colors.black ,

                                    )),
                                initialValue: task.title,
                                style: Theme.of(context).textTheme.headline4?.copyWith(color:settingsprovider.isDarkMode()?Colors.white:Colors.black),
                              )),
                          Container(
                              padding: const EdgeInsets.symmetric(
                                  vertical: 14, horizontal: 14),
                      ...
                      Center(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Center(child: Text(settingsprovider.currentLanguage=='en'?"Save Changes":"حفظ التعديلات",
